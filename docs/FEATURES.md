...
| **Set files and take diffing** | **shipped** — a set saved as readable, diffable text; two takes compared by move and drift. Replay *from* a file is not wired to the engine yet |
