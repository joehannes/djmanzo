...
---
# 117. ASKED SINCE: A MNEMONIC KEY SYSTEM, AND DASHBOARDS INSTEAD OF TOOLBARS
> so then, also i want you to:
> investigate/research a super usable and easy and easy to memorize and understand shortcut/keysystem for the app ...
> i'd love something like neov im mnemonic shortcuts ... with a visual feedback guide/legend where we are after each key in the shortcut chain with all the possible breadcrumbs/outcomes...
> i want 1,2,3, ... , not F1,F2,F3,... to switch views/activities ...
> i want very natural and typical (even per system linux/windows/mac) shortcuts and mnemonics ...
> i want them to be easily memorisable and orientated at English as the main language.
> let the user be capable of creating his own shortcuts/mnemonics as well and those shall be reflected in the visual guide.
> minimalise the use of toolbars/space ... so i can use every space for my focused activity widget ...
> instead of toolbards let there be an central dashboard view with easy nav buttons for packages/presets/activities/overview ... even different dashboards per purpose/activity ... and auto-arrangeable dashboards ... then each activity focuses on the activity and it is easy to pull up a mnemonic guide with a central trigger key ... eg. "space" bar ...
> subsequently extend the GUI arrangements and widgets around that ideology and make if functionally work and beautifully as of the actual work/activity/focus as on a live setting for a real DJ ...
---
# 118. ASKED SINCE: GUIDES, A WELCOME, AND THE WORKFLOW FROM PRACTICE TO THE EVENT
> new feature:
> the integrated ai assistant shall have different guides that are visually represented via floating widgets with visual presentations of topics and representations of (multi-choice) options that are easy to identify. whenever in a stressful situation a decision becomes necessary a super easy and quick to identify and select widget can pop up (as unobtrusive or occupying as necessary and adequate) ... also a new user is welcomed by a guide that introduces to the capabilities and metaphorical usage and navigation and features and workflow of the app.
> therefor also:
> i want you to work on the topic workflow. a dj first learns and practices. skillfully combines and encounters a set on a topic ... let there be features and workflows to make his life wonderful in many ways.
> then he might prepare for a specific event ... top up on assisted dj skills so they become super convenient to apply (also combine, extend) ...
> also make a workflow and an activity to specifically prepare a set/show for an event ... the topic, the genre, the location, the music, the songs, the transitions, the duration, the fallbacks, the extras, the wishes, the flexibility, the alternatives ... the emergency cases ... the specials, the after bonus ... enable the dj to prepare specifically and in many ways and store every step in a decent way ... and save his preparation/work to load it for the live event ...
> the live event: narrow focus, specific, prepared, flexible/extendible but starting exactly the way it should ... prepared for exceptions and emergencies/alternatives...
> prepared for variations in location/crowd/mood/weather ... whatever a DJ typically as confronted with.
> also assist in finding the right ideas/preparation ...
> have a place for the dj to save his details and all possible details he might want to pass on quickly in the event: personal details, music, songs, calender, pricings, job circumstantial fact sheets, how to be booked, profile, channels, social presences ... documents ... experience, photos ... the DJ can accumulate his personal stuff in a orchestrated way and on the occasion has easy and direct access to many share mechanisms that are prepackaged/optimised for typical practical occasions/opportunities.
